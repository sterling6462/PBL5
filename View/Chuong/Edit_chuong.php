    ...
    <a href="index.php?controller=chuong&action=list&idtruyen=<?= $idtruyen?>">&laquo;Quay lại</a>
        ...
        <form action=" " method="POST" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>Chương số</td>
                    <td><input type="text" name="chuongso" placeholder="Chương số" value="<?= $chuong->Chuongso ?>" />
                    </td>
                </tr>
                <tr>
                    <td>Tiêu đề</td>
                    <td><input type="text" name="chuongten" placeholder="Chương tên"
                            value="<?= $chuong->Chuongten ?>" /></td>
                </tr>
                <tr>
                    <td>Nội dung</td>
